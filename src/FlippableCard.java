...
public class FlippableCard extends JButton
{
    ...
    private ImageIcon originalBack = new ImageIcon(loader.getResource("pictures/graySquare.jpg"));
    private Image originalBackImage = originalBack.getImage();
    private Image newBackImage = originalBackImage.getScaledInstance(60,50, java.awt.Image.SCALE_SMOOTH);
